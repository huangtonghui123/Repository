...
<head lang="en">
    ...
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/staticResource/css/style.css"/>
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/staticResource/css/public.css"/>
</head>
<body>
<!--头部-->
    ...
    <div class="left">
        ...
        <nav>
            <ul class="list">
                ...
                <li><a href="${pageContext.request.contextPath }/user/passwordModify.html">密码修改</a></li>
                <li><a href="${pageContext.request.contextPath }/login/logout.html">退出系统</a></li>
            </ul>
        </nav>
    </div>
