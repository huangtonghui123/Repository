...
<div class="right">
        ...
        <div class="providerAdd">
           <fm:form enctype="multipart/form-data" id="providerForm" modelAttribute="provider" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/addProviderSave.html">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/staticResource/js/provideradd.js"></script>
