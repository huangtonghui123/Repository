...
<div class="right">
    ...
    <div class="providerAdd">
        <fm:form modelAttribute="user" enctype="multipart/form-data" id="userForm" name="userForm" method="post"
                 action="${pageContext.request.contextPath }/user/addUserSave.html">
            ...
            <div>
                ...
                <!-- 列出所有的角色分类 -->
                <fm:select name="userRole" id="userRole" path="userRole"></fm:select>
                <font color="red"></font>
            </div>
            <div>
            ...
            <div>
                <label for="a_workPicPath">工作证件照：</label>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/staticResource/js/useradd.js"></script>
