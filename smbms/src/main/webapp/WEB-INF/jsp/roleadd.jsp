...
<div class="right">
    ...
    <div class="providerAdd">
        <form modelAttribute="role" id="roleForm" name="roleForm" method="post"
...
<script type="text/javascript" src="${pageContext.request.contextPath }/staticResource/js/roleadd.js"></script>
